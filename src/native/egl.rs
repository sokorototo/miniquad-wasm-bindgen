...
pub type PFNEGLCHOOSECONFIGPROC = ::std::option::Option<unsafe extern "C" fn(dpy: EGLDisplay, attrib_list: *const EGLint, configs: *mut EGLConfig, config_size: EGLint, num_config: *mut EGLint) -> EGLBoolean>;
pub type PFNEGLCOPYBUFFERSPROC = ::std::option::Option<unsafe extern "C" fn(dpy: EGLDisplay, surface: EGLSurface, target: EGLNativePixmapType) -> EGLBoolean>;
pub type PFNEGLCREATECONTEXTPROC = ::std::option::Option<unsafe extern "C" fn(dpy: EGLDisplay, config: EGLConfig, share_context: EGLContext, attrib_list: *const EGLint) -> EGLContext>;
pub type PFNEGLCREATEPBUFFERSURFACEPROC = ::std::option::Option<unsafe extern "C" fn(dpy: EGLDisplay, config: EGLConfig, attrib_list: *const EGLint) -> EGLSurface>;
pub type PFNEGLCREATEPIXMAPSURFACEPROC = ::std::option::Option<unsafe extern "C" fn(dpy: EGLDisplay, config: EGLConfig, pixmap: EGLNativePixmapType, attrib_list: *const EGLint) -> EGLSurface>;
pub type PFNEGLCREATEWINDOWSURFACEPROC = ::std::option::Option<unsafe extern "C" fn(dpy: EGLDisplay, config: EGLConfig, win: EGLNativeWindowType, attrib_list: *const EGLint) -> EGLSurface>;
pub type PFNEGLDESTROYCONTEXTPROC = ::std::option::Option<unsafe extern "C" fn(dpy: EGLDisplay, ctx: EGLContext) -> EGLBoolean>;
pub type PFNEGLDESTROYSURFACEPROC = ::std::option::Option<unsafe extern "C" fn(dpy: EGLDisplay, surface: EGLSurface) -> EGLBoolean>;
pub type PFNEGLGETCONFIGATTRIBPROC = ::std::option::Option<unsafe extern "C" fn(dpy: EGLDisplay, config: EGLConfig, attribute: EGLint, value: *mut EGLint) -> EGLBoolean>;
pub type PFNEGLGETCONFIGSPROC = ::std::option::Option<unsafe extern "C" fn(dpy: EGLDisplay, configs: *mut EGLConfig, config_size: EGLint, num_config: *mut EGLint) -> EGLBoolean>;
pub type PFNEGLGETCURRENTDISPLAYPROC = ::std::option::Option<unsafe extern "C" fn() -> EGLDisplay>;
pub type PFNEGLGETCURRENTSURFACEPROC = ::std::option::Option<unsafe extern "C" fn(readdraw: EGLint) -> EGLSurface>;
pub type PFNEGLGETDISPLAYPROC = ::std::option::Option<unsafe extern "C" fn(display_id: EGLNativeDisplayType) -> EGLDisplay>;
pub type PFNEGLGETERRORPROC = ::std::option::Option<unsafe extern "C" fn() -> EGLint>;
pub type PFNEGLGETPROCADDRESSPROC = ::std::option::Option<unsafe extern "C" fn(procname: *const ::std::os::raw::c_char) -> __eglMustCastToProperFunctionPointerType>;
pub type PFNEGLINITIALIZEPROC = ::std::option::Option<unsafe extern "C" fn(dpy: EGLDisplay, major: *mut EGLint, minor: *mut EGLint) -> EGLBoolean>;
pub type PFNEGLMAKECURRENTPROC = ::std::option::Option<unsafe extern "C" fn(dpy: EGLDisplay, draw: EGLSurface, read: EGLSurface, ctx: EGLContext) -> EGLBoolean>;
pub type PFNEGLQUERYCONTEXTPROC = ::std::option::Option<unsafe extern "C" fn(dpy: EGLDisplay, ctx: EGLContext, attribute: EGLint, value: *mut EGLint) -> EGLBoolean>;
pub type PFNEGLQUERYSTRINGPROC = ::std::option::Option<unsafe extern "C" fn(dpy: EGLDisplay, name: EGLint) -> *const ::std::os::raw::c_char>;
pub type PFNEGLQUERYSURFACEPROC = ::std::option::Option<unsafe extern "C" fn(dpy: EGLDisplay, surface: EGLSurface, attribute: EGLint, value: *mut EGLint) -> EGLBoolean>;
pub type PFNEGLSWAPBUFFERSPROC = ::std::option::Option<unsafe extern "C" fn(dpy: EGLDisplay, surface: EGLSurface) -> EGLBoolean>;
pub type PFNEGLTERMINATEPROC = ::std::option::Option<unsafe extern "C" fn(dpy: EGLDisplay) -> EGLBoolean>;
pub type PFNEGLWAITGLPROC = ::std::option::Option<unsafe extern "C" fn() -> EGLBoolean>;
pub type PFNEGLWAITNATIVEPROC = ::std::option::Option<unsafe extern "C" fn(engine: EGLint) -> EGLBoolean>;
pub type PFNEGLBINDTEXIMAGEPROC = ::std::option::Option<unsafe extern "C" fn(dpy: EGLDisplay, surface: EGLSurface, buffer: EGLint) -> EGLBoolean>;
pub type PFNEGLRELEASETEXIMAGEPROC = ::std::option::Option<unsafe extern "C" fn(dpy: EGLDisplay, surface: EGLSurface, buffer: EGLint) -> EGLBoolean>;
pub type PFNEGLSURFACEATTRIBPROC = ::std::option::Option<unsafe extern "C" fn(dpy: EGLDisplay, surface: EGLSurface, attribute: EGLint, value: EGLint) -> EGLBoolean>;
pub type PFNEGLSWAPINTERVALPROC = ::std::option::Option<unsafe extern "C" fn(dpy: EGLDisplay, interval: EGLint) -> EGLBoolean>;
...
pub unsafe fn create_egl_context(egl: &mut LibEgl, display: *mut std::ffi::c_void, alpha: bool, sample_count: i32) -> Result<(EGLContext, EGLConfig, EGLDisplay), EglError> {
	...
	(egl.eglChooseConfig.unwrap())(display, cfg_attributes.as_ptr() as _, available_cfgs.as_ptr() as _, 32, &mut cfg_count as *mut _ as *mut _);
	assert!(cfg_count > 0);
	assert!(cfg_count <= 32);
	...
	for c in &mut available_cfgs[0..cfg_count] {
		...
		if (egl.eglGetConfigAttrib.unwrap())(display, *c, EGL_RED_SIZE as _, &mut r) == 1
			...
			&& r == 8 && g == 8
			&& b == 8 && (alpha_size == 0 || a == alpha_size as _)
			&& d == 16
		{
	...
	let context = (egl.eglCreateContext.unwrap())(display, config, /* EGL_NO_CONTEXT */ null_mut(), ctx_attributes.as_ptr() as _);
	if context.is_null() {
